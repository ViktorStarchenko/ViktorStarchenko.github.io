...
(function() {
    document.addEventListener("DOMContentLoaded", function() {
        if ("IntersectionObserver" in window) {
            var c = document.querySelectorAll(".lazy");
            var d = new IntersectionObserver(function(a, e) {
                a.forEach(function(a) {
                    a.isIntersecting && (a = a.target, a.src = a.dataset.src, a.classList.remove("lazy"), d.unobserve(a))
                })
            });
            ...
            var a = function() {
                    ...
                    b = setTimeout(function() {
                        ...
                        c.forEach(function(a) {
                            a.offsetTop < window.innerHeight + b && (a.src = a.dataset.src, a.classList.remove("lazy"))
                        });
                        0 == c.length && (document.removeEventListener("scroll", a), window.removeEventListener("resize", a), window.removeEventListener("orientationChange", a))
                    }, 20)
                },
                b;
            c = document.querySelectorAll(".lazy");
...
function addFix() {
    breakpoint = !0, $("header").addClass("fixed")
}

function removeFix() {
    breakpoint = !1, $("header").removeClass("fixed")
}
$(window).scroll(function() {
        80 < $(this).scrollTop() && !breakpoint && addFix(), $(this).scrollTop() < 80 && breakpoint && removeFix()
    }), $("#hamburger-btn").click(function(e) {
        e.preventDefault(), $("#mobile_menu").toggleClass("menu-active"), $("#menu-shadow").toggleClass("shadow-active"), $(this).toggleClass("is-active")
    }), $("#menu-shadow").click(function() {
        $(this).hasClass("shadow-active") && ($(this).fadeOut(200).removeClass("shadow-active"), $("#hamburger-btn").removeClass("is-active"), $("#mobile_menu").removeClass("menu-active"), $(".callback-modal").fadeOut().removeClass("callback-modal-active"))
    }), $(".toggle-callback-modal").click(function(e) {
        e.preventDefault(), $(".callback-modal").fadeIn().addClass("callback-modal-active"), $("#menu-shadow").fadeIn().addClass("shadow-active")
    }), $(".modal-close").click(function(e) {
        e.preventDefault(), $(".callback-modal").fadeOut().removeClass("callback-modal-active"), $("#menu-shadow").fadeOut(200).removeClass("shadow-active")
    }), $("#hamburger-btn-catalog").click(function(e) {
        e.preventDefault(), $(".catalog-nav").slideToggle(), $(this).toggleClass("is-active")
    ...
    $(".cuality-carousel").slick({
        ...
        autoplaySpeed: 2e3,
        speed: 1500
    }), $("#phone").mask("+38(000) 000-00-00"), $(".our_works_album").lightGallery(), $(".reviews_carousel").slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        autoplay: !0,
        autoplaySpeed: 2e3,
...
$(document).ready(function() {
    $('form').submit(function() {
        ...
        action($(this).attr('action'), $(this).serialize()).done(res => {
...
// script for new pages
$(document).ready(function() {
    (new universalParallax).init({
        speed: 9
    });
    $("#button-aab").on("click", function() {
        $(".offer-description__wrapper_aab").show(), $(".offer-description__wrapper_siemens").hide()
    }), $("#button-siemens").on("click", function() {
        $(".offer-description__wrapper_siemens").show(), $(".offer-description__wrapper_aab").hide()
        ...
        $(".brand-reason__left").show(), $(".brand-reason__right").hide()
    }), $("#brand-reason__right").on("click", function() {
        $(".brand-reason__right").show(), $(".brand-reason__left").hide()
    })
}), $(window).on("load scroll", () => {
    $("img.important-img-left.to-tilt").each((t, i) => {
        addShowClass(i, "important-tilt-minus")
    }), $("img.important-img-up.to-tilt").each((t, i) => {
        addShowClass(i, "important-tilt-up")
    }), $("img.important-img-right.to-tilt").each((t, i) => {
        addShowClass(i, "important-tilt-plus")
    }), $(".mystery-img-left").each((t, i) => {
        addShowClass(i, "mystery-tilt-minus")
    }), $(".mystery-img-up").each((t, i) => {
        addShowClass(i, "mystery-tilt-up")
    }), $(".mystery-img-right").each((t, i) => {
        addShowClass(i, "mystery-tilt-plus")
    })
}), addShowClass = ((t, i) => {
