        ...
        <div class="menu_list">
            ...
            <?php foreach ($terms as $item) { ?>
                <div class="menu_list__item active">
                    ...
                    if($item->parent == 0) { ?>
                        <span class="title-h3 menu_list__title text_underlined"><?php echo $item->name; ?></span>
                    <?php } ?>
...
//                        $term = get_term_by( 'id', $child, 'food_category' ); // get the child object ?>
                        <div class="menu_content__item">
                            <div class="menu_content__category text_underlined" id="<?php echo $child->slug ?>"><?php echo $child->name ?></div>
